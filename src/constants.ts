export const ALL_LANGUAGES = [
  ...
  "Corsican", "Croatian", "Czech", "Danish", "Dhivehi", "Dogri", "Dutch", 
  "English", "Esperanto", "Estonian", "Ewe", "Filipino", "Finnish", "French", "Frisian", 
  ...
  "Myanmar (Burmese)", "Nepali", "Norwegian", "Odia (Oriya)", "Oromo", 
  ...
  "Turkish", "Turkmen", "Twi", "Ukrainian", "Urdu", "Uyghur", "Uzbek", "Vietnamese", 
